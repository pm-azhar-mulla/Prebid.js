// hash: mPJaJrP2irfcuCwNtAFF0N5/sPcv0KS+0jfVcpNC4CFR7UR47pauvgpYw8Xn/kSPKyNSnNEKLvLZgU2r/x+QZsmglrg47cxerOb2KULC+dxiD9rER72NQgyeH2jSI06L5tz7n6j+IOjuoBslzjwKGtAKJQykxlGfheyBPai4/Rs=
var _ADAGIO = function(e) {
      ...
      , ut = function() {
        return o((function e(t) {
            ...
            value: function() {
                ...
                return this.refreshConfig || (this.doNotRefresh = !0),
            ...
            value: function(e) {
                var t;
                return (t = this.featuresManager.get(e)) || Pe("No features found for ".concat(e)),
                t
            }
        }, {
      ...
      , Et = function(t, i) {
        ...
        if ("ssp-data" === t.action) {
            ...
            var k = u.ADAGIO.pbjsAdUnits.filter((function(e) {
              ...
              , N = w.adg_rtd && w.adg_rtd.placement ? w.adg_rtd.placement : w.placement;
            k.push({
                code: m,
                mediaTypes: D,
                sizes: Array.from(x),
            ...
            !function(e, t, n, i) {
                ...
                if ("slotRenderEnded" === e.data.eventName) {
                    ...
                    if (p.length > 0) {
                        if (p[0].bids.length && p[0].bids[0].params && -1 !== [].indexOf(p[0].bids[0].params.organizationId))
            ...
            var P = t.data && t.data.session ? t.data.session : {}
              , R = P.rnd
              , T = P.id
              , B = P.new
              , L = P.initiator
              , z = P.v
              , M = P.lastActivityTime;
            try {
                s.startOrUpdate({
                    rnd: R,
                    id: T,
    ...
    !function() {
        ...
        e.ADAGIO && !0 === e.ADAGIO.loaded ? Pe("adagio.js already loaded") : (!function() {
            ...
            e.ADAGIO.versions.adagiojs = "2.1.11",
        ...
        Pe("adagio.js loaded: vers. ".concat("2.1.11")),
        e.ADAGIO.loaded = !0)
    }();
